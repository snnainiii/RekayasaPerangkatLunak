...
<body>
    ...
    <div class="box_edit_time_fs" id="box_edit_time_fs">
        <div class="edit_time_fs">
            ...
            <input type="text" class="input" id="time_fs" value="<?php echo date("d M Y H:i:s", $wb_fs); ?>"
                placeholder="Waktu Flash Sale">
    ...
    <div class="box_edit_time_fs" id="box_tp_fs">
        <div class="edit_time_fs">
            ...
            <select class="input" id="id_produk_new_fs">
                ...
                ?>
                <option value="<?php echo $data_produk_non_fs['id']; ?>">
                    <?php echo substr($data_produk_non_fs['judul'], 0, 45); ?></option>
                <?php
                }
                ?>
            </select>
            ...
            <div class="isi_content_admin">
                ...
                <div class="produk_fs">
                    ...
                    <div class="isi_all_users_admin">
                        ...
                        <div class="bu_edit_aua"
                            onclick="showg_edit_pro_fs('<?php echo $data_produk_fs['id']; ?>', `<?php echo $data_produk_fs['judul']; ?>`, '<?php echo $data_produk_fs['diskon']; ?>')">
