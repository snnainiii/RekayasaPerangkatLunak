        ...
        <div class="box_isi_cart">
            ...
            <div class="isi_cart" id="isi_cart<?php echo $cart_data['id']; ?>">
                ...
                <div class="box_detail_isi_cart">
                    ...
                    <div class="bayar" id="button_checkout<?php echo $cart_data['id']; ?>"
                        onclick="checkout('<?php echo $cart_data['id']; ?>', 'idkontol')">Checkout</div>
                    <div class="bayar loading_checkout" id="loading_checkout<?php echo $cart_data['id']; ?>"><img
                            src="../assets/icons/loading-w.svg" alt=""></div>
                    <div class="box_remove_cart" onclick="removecart(<?php echo $cart_data['id']; ?>)">
                        ...
                        <img src="../assets/icons/loading-o.svg"
                            id="loading_remove_cart<?php echo $cart_data['id']; ?>">
                    </div>
                </div>
            </div>
            <?php
