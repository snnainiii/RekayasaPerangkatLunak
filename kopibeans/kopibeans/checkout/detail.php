            ...
            <div class="form_provinsi_kota">
                <div class="isi_form_provinsi_kota">
                    <select class="select" id="provinsi" onchange="changeProvinsi()">
                        ...
                        ?>
                        <option value="<?php echo $value_provinsi_isi_data['province_id']; ?>">
                            <?php echo $value_provinsi_isi_data['province']; ?></option>
                        <?php
                        }
                        ?>
                    </select>
        ...
        <div class="transfer_manual">
            ...
            <div class="box_transfer_manual">
                <div class="isi_box_transfer_manual">
                    ...
                    <h6><strong>BANK MANDIRI 123-111-111 AN Alam</strong><br>
                        <strong>BANK BRI 123-111-122 AN Aini</strong><br>
                        <strong>BANK BNI 123-111-333 AN Ufi</strong><br>
                        <strong>BANK BBCA 123-111-555 AN Hesti</strong>
                    </h6>
                    </p>
                </div>
                <div class="isi_box_transfer_manual">
                ...
                <div class="isi_box_transfer_manual">
                    <div class="button" id="ubt"
                        onclick="upload_bukti_transfer_manual('<?php echo $id_invoice; ?>', '<?php echo $data_norek['nama_bank']; ?>')">
